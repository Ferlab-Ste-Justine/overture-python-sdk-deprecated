...
from .utils import Builder, default_value
from typing import List
from dataclasses import is_dataclass, asdict
from .utils import check_type, check_state
...
class Sample(Metadata, Validatable):
    ...
    @classmethod
    def create(cls, specimenId, submitterSampleId, matchedNormalSubmitterSampleId,
...
class Specimen(Metadata, Validatable):
    ...
    @classmethod
    def create(cls, donorId, submitterSpecimenId, specimenType, specimenTissueSource,
